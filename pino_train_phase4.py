...
def train_phase4():
    ...
    dataset_path = "data/pino_v3_dataset_phase4.pt"
    if not os.path.exists(dataset_path):
        print("[!] Dataset Phase 3 não encontrado. Execute augment_dataset_phase4.py primeiro.")
        return
    ...
    torch.save(model.state_dict(), "weights/pino_v3_phase4_final.pth")
    print("\n[+] Finetuning Phase 3 Concluído! Pesos salvos em 'weights/pino_v3_phase4_final.pth'")
